...
import (
	...
	"golang-intern/assignment-2/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Location, c.Report, c.SchemaMigration, c.Source, c.SourceEarthquake,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		SchemaMigration, Source, SourceEarthquake []ent.Hook
	}
	inters struct {
		Apireq, Earthquake, FeatureType, FtypeEarthquake, Geometry, Location, Report,
		SchemaMigration, Source, SourceEarthquake []ent.Interceptor
	}
)
